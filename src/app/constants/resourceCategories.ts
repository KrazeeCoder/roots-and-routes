...
export const RESOURCE_CATEGORY_META: Record<ResourceCategory, ResourceCategoryMeta> = {
  "Food Assistance": {
    icon: Wheat,
    waypointDescription: "Nourishment stops and meal programs to fuel your journey.",
  ...
  "Health & Wellness": {
    icon: HeartPulse,
    waypointDescription: "Wellbeing checkpoints and care along your path.",
  ...
  "Housing Support": {
    icon: Home,
    waypointDescription: "Shelter waypoints and stability resources.",
  ...
  "Youth Programs": {
    icon: Users,
    waypointDescription: "Growth milestones and mentorship journeys.",
  ...
  "Job Help": {
    icon: Briefcase,
    waypointDescription: "Career pathways and employment routes.",
  ...
  "Community Events": {
    icon: Calendar,
    waypointDescription: "Gathering points and shared experiences.",
