...
export function SpotlightSection() {
  return (
    <section className="bg-[#F6F1E7] py-24 relative" id="spotlights">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          {/* Large Featured Card */}
          <div className="lg:col-span-7 group flex flex-col bg-white rounded-3xl overflow-hidden shadow-sm border border-[#E7D9C3] hover:border-[#A7AE8A] hover:shadow-md transition-all">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
            ...
            {/* Supporting Card 1 */}
            <div className="group flex flex-col sm:flex-row bg-white rounded-3xl overflow-hidden shadow-sm border border-[#E7D9C3] hover:border-[#A7AE8A] hover:shadow-md transition-all">
            ...
            {/* Supporting Card 2 */}
            <div className="group flex flex-col sm:flex-row bg-[#E7D9C3]/40 rounded-3xl overflow-hidden shadow-sm border border-[#E7D9C3] hover:border-[#A7AE8A] hover:shadow-md transition-all">
              <div className="relative sm:w-2/5 h-48 sm:h-auto overflow-hidden">
                <ImageWithFallback 
