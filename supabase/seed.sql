...
('Downtown Community Center', 'Community Support', 'A vibrant hub for community gatherings and local events.', 'The Downtown Community Center offers a safe, inclusive space for everyone. We host weekly workshops, provide access to computer labs, and organize community outreach programs to support local families. Come join our growing network of volunteers!', '123 Main St, Springfield, IL', '(555) 123-4567', 'https://example.com/dcc', 'Mon-Fri: 9AM-8PM, Sat: 10AM-4PM', '{"community", "workshops", "support", "volunteering"}', 'https://images.unsplash.com/photo-1576267423048-15c0040fec78?q=80&w=800', 'published', false, null, 'Jane Doe'),

('Green Valley Food Pantry', 'Food', 'Providing nutritious meals and groceries for families in need.', 'Green Valley Food Pantry partners with local farms and supermarkets to provide fresh, healthy food options to those facing food insecurity. We operate a drive-through pantry every Tuesday and Thursday.', '456 Oak Avenue, Springfield, IL', '(555) 987-6543', 'https://example.com/gvfood', 'Tue & Thu: 10AM-2PM', '{"food", "pantry", "groceries"}', 'https://images.unsplash.com/photo-1593113592332-6e2ee791ef60?q=80&w=800', 'published', true, 'Nourishing our community, one meal at a time', 'Mark Johnson'),

('Riverside Health Clinic', 'Healthcare', 'Affordable medical care and wellness checkups for the uninsured.', 'Riverside Health Clinic is dedicated to providing high-quality, free, or low-cost medical assistance to underserved populations. We offer general checkups, vaccinations, and mental health counseling by certified professionals.', '789 River Road, Springfield, IL', '(555) 456-7890', 'https://example.com/riversidehealth', 'Mon-Wed-Fri: 8AM-5PM', '{"healthcare", "clinic", "wellness", "mental-health"}', 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=800', 'published', true, 'Your health is our priority', 'Dr. Sarah Lee'),

('Springfield Pathways Housing', 'Housing', 'Emergency shelter and long-term housing assistance programs.', 'Springfield Pathways provides emergency overnight shelter as well as resources to help individuals transition into permanent housing. We also offer financial counseling and job placement assistance.', '101 Shelter Blvd, Springfield, IL', '(555) 222-3333', 'https://example.com/pathways', 'Open 24/7', '{"housing", "shelter", "assistance"}', 'https://images.unsplash.com/photo-1460317442991-0ec209397118?q=80&w=800', 'published', false, null, 'Community Admin'),

('Tech Forward Youth Program', 'Education', 'After-school coding and robotics program for teens.', 'Tech Forward aims to bridge the digital divide by offering free after-school technology classes for high school students. Students learn Python, web development, and build their own robots.', '202 Innovation Park, Springfield, IL', '(555) 555-0199', 'https://example.com/techforward', 'Mon-Fri: 3PM-6PM', '{"education", "technology", "youth"}', 'https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=800', 'published', false, null, 'Alice Rivera');
