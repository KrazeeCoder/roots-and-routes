...
('Bothell Community Farmers Market', 'Community Events', 'Weekly farmers market with local produce, crafts, and community gatherings.', 'The Bothell Farmers Market brings together local farmers, artisans, and community members every week. Features fresh produce, handmade goods, live music, and special events throughout the season.', '9919 NE 180th St, Bothell, WA 98011', 'https://www.bothellwa.gov/farmers-market', 'published', 'City of Bothell'),

('Northshore Housing Stability Fund', 'Housing Support', 'Emergency rental assistance for families in crisis.', 'A city-backed fund providing up to two months of emergency rental assistance for Bothell families facing eviction. Applications processed within 72 hours with case manager support.', 'Bothell City Hall, 18415 101st Ave NE, Bothell, WA 98011', 'https://www.bothellwa.gov/housing-assistance', 'published', 'City of Bothell');
